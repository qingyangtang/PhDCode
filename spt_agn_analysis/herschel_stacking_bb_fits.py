...
sptsz_ra, sptsz_dec, sptsz_flux = od.get_SPTSZ_ptsrcs(mapfreq, field="ra23h30dec-55_allyears")
...
# 	map_arr, reso_arcmin_arr, radec0_arr, npixels_arr, mapfreq_arr, zp_mask = od.make_SPTSZ_filtered_map(save_map = True, \
